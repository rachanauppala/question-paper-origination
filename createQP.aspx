<%@ Page Language="C#" AutoEventWireup="true" CodeFile="createQP.aspx.cs" Inherits="createQP" %>
...
<body>
    ...
    <form id="form2" runat="server" style="margin-top:-4px;">
        ...
        <nav class="nav-wrapper teal">
                <div class="container">
                    <a href="#" class="brand-logo">QP Origination</a>
    ...
    <div class="container">
        ...
        (i)<asp:TextBox ID="txtq1" runat="server" CssClass="validate" TextMode="MultiLine" placeholder="Type your Question here..."></asp:TextBox>
